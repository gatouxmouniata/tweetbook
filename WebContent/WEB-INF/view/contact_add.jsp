...
<div class="modal fade hide" id="contact_add_mod">
	<div class="modal-header">
		...
		<h3 align="center">Création d'un compte</h3>
	</div>
			...
			<table style="margin: 0 auto;">
				...
				<tr>
					<td align="center">
						...
						<hr>
						<label style="margin-left: 30px; font-weight: bold;">Information du compte:</label>
					</td>
				</tr>
					...
					<td>
						<div class="control-group">
							...
							<div class="controls">
								...
								tabindex="1" autocomplete="off" style="text-transform: none;" maxlength="50" required />
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="prenom" name="prenom" class="search-query" placeholder="Ex: Dupont"
									tabindex="3" autocomplete="off" style="text-transform: capitalize;" maxlength="50" required />
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input type="email" id="email" name="email" class="search-query" placeholder="exemple@domaine.com"
									tabindex="4" style="text-transform: none;" maxlength="60" required/>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="password" id="password" name="password" class="search-query" placeholder="password"
									tabindex="5" style="text-transform: none;" maxlength="60" required/>
							</div>
						</div>
